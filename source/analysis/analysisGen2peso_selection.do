...
global gphoptns scheme(lean2) ///
				ytitle("Child's birth weight in grams (2nd generation)") ///
				xtitle("Mother's birth weight in grams (1st generation)") ///
				legend(off) ylabel(2900(100)3300) xlabel(1100(100)1900)
...
/* 
Baseline estimates an approximately -49.53 gram effect of treatment (not 
statistically significant).

The effect would become 0 if we assume that girls that died within 1 year of
birth would have had a child somewhere between the 10th and 20th percentile of
birthweight, within mothers' 20g birthweight bins.
