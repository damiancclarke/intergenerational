...
global gphoptns scheme(lean2) ///
				ytitle("Child's birth size in cm (2nd generation)") ///
				xtitle("Mother's birth weight in grams (1st generation)") ///
				legend(off) ylabel(46(2)52)
...
/* 
Baseline estimates below 1cm. No significant selection effects.
*/
